...
const PopularPost = () => {
  ...
  return (
    <div className="w-full">
      <h1 className="text-center text-5xl font-bold pt-8">Popular Courses</h1>
      <div className="">
        {blog.map((val, i) => {
          return (
            <div
              ...
              } w-8/12 mx-auto   gap-10 pt-14 transition-all delay-100 duration-1000`}>
              <div className="mx-auto w-full">
                {val.image.map((image, i) => (
                  <img
                    src={image.path}
                    alt="img"
                    className="rounded-xl shadow-lg border-[1px] w-full h-[30rem] bg-[#ffffff]"
                  />
                ))}
              </div>
